...
@WebServlet(name = "DeletarPorTitulo", value = "/deletarportitulo")
public class DeletarPorTitulo extends HttpServlet {
    @Override
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println(manipulaXML.deletarTitulo(tituloPesq));
